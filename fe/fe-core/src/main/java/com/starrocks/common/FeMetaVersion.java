...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/common/FeMetaVersion.java
...
public final class FeMetaVersion {
    ...
    // added collation_server to variables (starrocks-3059)
    ...
    // add param: starrocks_shuffle_partitions
